      ...
      <section id="trend-services" className="py-12 max-w-7xl mx-auto px-4 md:px-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 md:gap-6">
          {[
            ...
            { name: "Kombi Servisi", image: "https://images.unsplash.com/photo-1621905252507-b35492cc74b4?q=80&w=600&auto=format&fit=crop", rating: "4.7", count: "2.100", commentCount: "1.840" },
            { name: "Koltuk Yıkama", image: "https://images.unsplash.com/photo-1584820927498-cfe5211fd8bf?q=80&w=600&auto=format&fit=crop", rating: "4.6", count: "1.540", commentCount: "1.230" },
          ].map((srv, idx) => (
