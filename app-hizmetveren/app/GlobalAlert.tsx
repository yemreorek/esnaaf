      ...
      <div className="bg-white/95 border border-slate-100 rounded-[32px] p-6 max-w-sm w-full shadow-2xl animate-scale-up space-y-6 text-center backdrop-blur-lg">
        ...
        <div className="pt-2">
          <button
            ...
            className="w-full bg-[#c8f252] text-slate-955 hover:bg-[#b5e639] text-xs font-black py-3 rounded-2xl cursor-pointer transition-all active:scale-95 border border-transparent shadow-md shadow-[#c8f252]/20 font-sans tracking-wide uppercase"
          >
            Tamam
          </button>
        </div>
