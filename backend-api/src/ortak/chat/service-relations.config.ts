...
export const SERVICE_CLUSTERS: ServiceCluster[] = [
  ...
  {
    clusterId: 'saaglikli-yasam',
    name: 'Sağlıklı Yaşam & Danışmanlık',
    icon: 'health_and_safety',
    primarySlugs: ['psikolog', 'diyetisyen', 'fizyoterapist'],
    subservices: [
      { slug: 'psikolog', title: 'Psikolog', categorySlug: 'ozel-ders' },
      { slug: 'klinik-psikolog', title: 'Klinik Psikolog', categorySlug: 'ozel-ders' },
      { slug: 'online-terapi', title: 'Online Terapi', categorySlug: 'ozel-ders' },
      { slug: 'aile-danismani', title: 'Aile Danışmanı', categorySlug: 'ozel-ders' },
      { slug: 'aile-terapisi', title: 'Aile Terapisi', categorySlug: 'ozel-ders' },
      { slug: 'cift-terapisi', title: 'Çift Terapisi', categorySlug: 'ozel-ders' },
      { slug: 'cocuk-psikologu', title: 'Çocuk Psikoloğu', categorySlug: 'ozel-ders' },
      { slug: 'ergen-psikologu', title: 'Ergen Psikoloğu', categorySlug: 'ozel-ders' },
      { slug: 'diyetisyen', title: 'Diyetisyen', categorySlug: 'ozel-ders' },
      { slug: 'online-diyetisyen', title: 'Online Diyetisyen', categorySlug: 'ozel-ders' },
      { slug: 'fizyoterapist', title: 'Fizyoterapist', categorySlug: 'ozel-ders' },
      { slug: 'evde-fizik-tedavi', title: 'Evde Fizik Tedavi', categorySlug: 'ozel-ders' },
      { slug: 'evde-hemsire', title: 'Evde Hemşire', categorySlug: 'ev-temizligi' },
      { slug: 'evde-serum-takma', title: 'Evde Serum Takma', categorySlug: 'ev-temizligi' },
      { slug: 'personal-trainer', title: 'Personal Trainer', categorySlug: 'ozel-ders' },
      { slug: 'pilates-dersi', title: 'Pilates Dersi', categorySlug: 'ozel-ders' },
      { slug: 'reformer-pilates-dersi', title: 'Reformer Pilates Dersi', categorySlug: 'ozel-ders' },
      { slug: 'yasam-kocu', title: 'Yaşam Koçu', categorySlug: 'ozel-ders' },
      { slug: 'dil-ve-konusma-terapisi', title: 'Dil ve Konuşma Terapisi', categorySlug: 'ozel-ders' },
      { slug: 'emdr-terapisi', title: 'EMDR Terapisi', categorySlug: 'ozel-ders' },
    ],
  },
  {
    clusterId: 'evcil-hayvanlar',
    name: 'Evcil Hayvan Bakımı & Kuaför',
    icon: 'pets',
    primarySlugs: ['evcil-hayvan-bakimi', 'pet-kuaforu', 'kopek-oteli'],
    subservices: [
      { slug: 'evde-kedi-bakimi', title: 'Evde Kedi Bakımı', categorySlug: 'ev-temizligi' },
      { slug: 'evde-kopek-bakimi', title: 'Evde Köpek Bakımı', categorySlug: 'ev-temizligi' },
      { slug: 'kedi-bakimi', title: 'Kedi Bakımı', categorySlug: 'ev-temizligi' },
      { slug: 'kopek-bakimi', title: 'Köpek Bakımı', categorySlug: 'ev-temizligi' },
      { slug: 'kedi-trasi', title: 'Kedi Traşı', categorySlug: 'ev-temizligi' },
      { slug: 'kopek-trasi', title: 'Köpek Traşı', categorySlug: 'ev-temizligi' },
      { slug: 'pet-kuaforu', title: 'Pet Kuaförü', categorySlug: 'ev-temizligi' },
      { slug: 'kedi-kuaforu', title: 'Kedi Kuaförü', categorySlug: 'ev-temizligi' },
      { slug: 'kopek-kuaforu', title: 'Köpek Kuaförü', categorySlug: 'ev-temizligi' },
      { slug: 'kopek-oteli', title: 'Köpek Oteli', categorySlug: 'ev-temizligi' },
      { slug: 'kedi-oteli', title: 'Kedi Oteli', categorySlug: 'ev-temizligi' },
      { slug: 'kopek-pansiyonu', title: 'Köpek Pansiyonu', categorySlug: 'ev-temizligi' },
      { slug: 'kopek-egitimi', title: 'Köpek Eğitimi', categorySlug: 'ozel-ders' },
      { slug: 'kopek-gezdirme', title: 'Köpek Gezdirme', categorySlug: 'ev-temizligi' },
    ],
  },
  {
    clusterId: 'dijital-kurumsal',
    name: 'Dijital, Kurumsal & Yazılım',
    icon: 'laptop_mac',
    primarySlugs: ['seo-hizmeti', 'grafik-tasarim', 'internet-sitesi-olusturma'],
    subservices: [
      { slug: 'internet-sitesi-olusturma', title: 'İnternet Sitesi Oluşturma', categorySlug: 'organizasyon' },
      { slug: 'mobil-uygulama-gelistirme', title: 'Mobil Uygulama Geliştirme', categorySlug: 'organizasyon' },
      { slug: 'seo-hizmeti', title: 'SEO Hizmeti', categorySlug: 'organizasyon' },
      { slug: 'grafik-tasarim', title: 'Grafik Tasarım', categorySlug: 'organizasyon' },
      { slug: 'logo-tasarimi', title: 'Logo Tasarımı', categorySlug: 'organizasyon' },
      { slug: 'kurumsal-logo-tasarimi', title: 'Kurumsal Logo Tasarımı', categorySlug: 'organizasyon' },
      { slug: 'sosyal-medya-yonetimi', title: 'Sosyal Medya Yönetimi', categorySlug: 'organizasyon' },
      { slug: 'google-ads-uzmani', title: 'Google Ads Uzmanı', categorySlug: 'organizasyon' },
      { slug: 'meta-reklam-yoneticisi', title: 'Meta Reklam Yöneticisi', categorySlug: 'organizasyon' },
      { slug: 'e-ticaret-danismanligi', title: 'E-Ticaret Danışmanlığı', categorySlug: 'organizasyon' },
      { slug: 'vize-danismanlik', title: 'Vize Danışmanlığı', categorySlug: 'organizasyon' },
      { slug: 'yeminli-tercume', title: 'Yeminli Tercüme', categorySlug: 'ozel-ders' },
      { slug: 'ingilizce-ceviri', title: 'İngilizce Çeviri', categorySlug: 'ozel-ders' },
      { slug: '3d-animasyon', title: '3D Animasyon', categorySlug: 'organizasyon' },
      { slug: '3d-baski', title: '3D Baskı', categorySlug: 'organizasyon' },
      { slug: 'isikli-tabela', title: 'Işıklı Tabela', categorySlug: 'tadilat' },
      { slug: 'tabela', title: 'Tabela İmalatı', categorySlug: 'tadilat' },
      { slug: 'apartman-yonetimi', title: 'Apartman Yönetimi', categorySlug: 'ev-temizligi' },
    ],
  },
  {
    clusterId: 'cesitli-diger',
    name: 'Çeşitli & Diğer Hizmetler',
    icon: 'more_horiz',
    primarySlugs: ['terzi', 'karavan-kiralama', 'ozel-dedektif'],
    subservices: [
      { slug: 'terzi', title: 'Terzi & Kıyafet Tadilatı', categorySlug: 'ev-temizligi' },
      { slug: 'ozel-dedektif', title: 'Özel Dedektif', categorySlug: 'organizasyon' },
      { slug: 'karavan-kiralama', title: 'Karavan Kiralama', categorySlug: 'nakliyat' },
      { slug: 'ahsap-dekorasyon', title: 'Ahşap Dekorasyon', categorySlug: 'tadilat' },
      { slug: 'aluminyum-pergole', title: 'Alüminyum Pergole', categorySlug: 'tadilat' },
      { slug: 'karot-kesim', title: 'Karot Kesim', categorySlug: 'tadilat' },
      { slug: 'otopark-bariyeri', title: 'Otopark Bariyeri', categorySlug: 'tadilat' },
      { slug: 'mutfak-dolabi-folyo-kaplama', title: 'Mutfak Dolabı Folyo Kaplama', categorySlug: 'tadilat' },
    ],
  },
];
