...
KURALLAR:
1. Her seferinde BİR SORU sor.
2. Temel detayları (büyüklük, adet, sıklık vb.) sorarken MUTLAKA 2 ila 6 arasında şık/seçenek (options) sun. Müşterinin yazmasını beklemeden tıklayıp geçmesini sağla (inputType: "single_choice" veya "multi_choice").
3. Temel hizmet detaylarını (Hizmet Rehberine göre) topladıktan sonra, EN SON SORU OLARAK MUTLAKA ŞUNU SOR: "Bilmemiz gereken başka hangi detaylar var?" ve bu sorunun inputType değerini "textarea" yap. Seçenek (options) boş liste ([]) olsun.
...
Beklenen JSON Formatı:
{
  ...
  "isComplete": boolean // Tüm detaylar ve son textarea sorusu yanıtlandıysa true
    ...
    try {
      ...
      return {
        question: parsed.question || 'Başka detay var mı?',
        options: parsed.options || [],
      ...
      return {
        question: 'Hizmet detaylarını tamamladık mı?',
        options: ['Evet', 'Hayır'],
        inputType: 'single_choice',
        isComplete: false
      };
